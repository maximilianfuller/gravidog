...
import miweinst.engine.beziercurve.LineSegment;
...
public class TestCollisionVisualizer {
	...
	private TestEntity _testCircle, _testRect, _testPolygonA, _testCurve;
...
//////	TESTER FOR ONLY CHECKING ONE SHAPE AGAINST THE OTHER
		if (_testArr[3].collides(_testArr[0])) {
			_testArr[3].setShapeColor(new Color(r,g,b));
			_testArr[0].setShapeColor(new Color(r,g,b));
		}
